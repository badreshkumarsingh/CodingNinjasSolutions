...
required & min: https://mongoosejs.com/docs/validation.html#built-in-validators

## Notes/Hints:

1. No need to change prewritten code.
2. Use the "required" attribute for the mandatory field & "min" attribute with minimum value constraint.
3. For comprehensive details, consult the official Mongoose documentation given below:
   
   • required: "https://mongoosejs.com/docs/validation.html#built-in-validators"
   ...
   • min: "https://mongoosejs.com/docs/validation.html#built-in-validators"
...
4. Pay close attention to the field types, requirements, and constraints specified in the objectives.
